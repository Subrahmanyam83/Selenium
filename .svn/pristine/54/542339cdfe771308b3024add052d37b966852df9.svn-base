...
/**
 *
 * This test script contains test method(s) for Contests page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestContests extends BaseTest {
	...
	public void testContests(){
		...
		selenium.logComment("Navigating to Contests Page");
		selenium.logComment("Verifying that all the required elements are present on Test Contests Page");
		...
		selenium.logComment("Navigating to Contests Page");
		watchVideosPage.clickContestsWatchNow();
