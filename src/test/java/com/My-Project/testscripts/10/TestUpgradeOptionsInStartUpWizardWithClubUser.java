 ...
 * This test script contains test method for verifying that when user logs in as club user/coach user, user is NOT displayed
 * any upgrade options
 * @author Gaurav
 */
public class TestUpgradeOptionsInStartUpWizardWithClubUser extends BaseTest {
	 ...
	 */
	@Test
	public void testUpgradeOptionsInStartUpWizardWithClubUser() {
