...
/**
 * 
 * This test script contains test method for verifying user can complete startup wizard without giving
 * any feedback.
 * @author Gaurav
 */
public class TestCompleteStartUpWizardWithoutFeedback extends BaseTest {
	...
	/**
	 * This test method verifies user can complete Start Up Wizard without giving any feedback.
	 */
	@Test
	public void testCompleteStartUpWizardWithoutFeedback() {
		...
		gettingStartedWizardPage.submitWithoutFeedback();
