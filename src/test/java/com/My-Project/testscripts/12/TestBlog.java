...
public class TestBlog extends BaseTest implements BlogTab {
	...
	public void testViewBlog() {
		...
		selenium.logComment("Click on 'Blog' link.");
		selenium.logComment("Verify that all the required elements are available on Edit Blog Page.");
		selenium.logComment("Click on 'Add Blog Entry' Button.");
		selenium.logComment("Verify that all the required elements are available on Add Blog Entry Page.");
	...
	public void testAddBlogEntry( String blogTitle, String month, String day, String year, String hour, String min, String ampm, String blogText, String blogTag, String privacyLevel) {
		...
		selenium.logComment("Type title in Title Text box.");
		blogPage.typeBlogTitle(blogTitle);

		selenium.logComment("Select Date");
		blogPage.selectPublishDate(month, day, year, hour, min, ampm);

		selenium.logComment("Type content in Blog text area.");
		blogPage.typeBlogContent(blogText);

		selenium.logComment("Type tags.");
		blogPage.typeTagsContent(blogTag);

		selenium.logComment("Select Privacy Level.");
		blogPage.selectPrivacyLevel(privacyLevel);

		selenium.logComment("Click Publish Button.");
		blogPage.publishBlog();

		selenium.logComment("Verifying that the blog is saved successfully.");
	...
	public void testEditBlogEntry(String editedBlogTitle, String editedBlogText) {
		...
		selenium.logComment("Click on Edit icon to open blog in edit mode.");
		blogPage.clickEditBlogIcon();

		selenium.logComment("Verify the label 'Update Entry is avaialble.");
		...
		selenium.logComment("Type edited content in blog textarea.");
		blogPage.typeBlogContent(editedBlogText);

		selenium.logComment("Click Publish Button.");
		blogPage.publishBlog();

		selenium.logComment("Verifying that the changes are saved successfully.");
	...
	public void testDeleteBlogEntry() {
		...
		selenium.logComment("Click on 'Cancel' button in next confirmation popup.");
		blogPage.clickCancelOnNextConfirmation();

		selenium.logComment("Click on 'Delete' button.");
		blogPage.deleteBlogEntry();

		selenium.logComment("Verify the popup is displayed.");
		...
		selenium.logComment("Click on 'Ok' button in next confirmation popup.");
