...
/**
 *
 * This test script contains test method(s) for Team Beachbody page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestTeamBeachbody extends BaseTest {
	...
	public void testTeamBeachbody(){
		...
		selenium.logComment("Navigating to Team Beachbody Page");
		selenium.logComment("Verifying that all the required elements are present on Team Beachbody Page");
		...
		selenium.logComment("Navigating to Team Beachbody Page");
		watchVideosPage.clickTeamBeachbodyWatchNow();
