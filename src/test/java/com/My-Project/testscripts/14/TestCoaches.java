...
/**
 *
 * This test script contains test method(s) for Coaches page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestCoaches extends BaseTest {
	...
	public void testCoaches(){
		...
		selenium.logComment("Navigating to Coaches Page");
		selenium.logComment("Verifying that all the required elements are present on Coaches Page");
		...
		selenium.logComment("Navigating to Coaches Page");
		watchVideosPage.clickCoachesWatchNow();
