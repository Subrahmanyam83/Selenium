...
/**
 *
 * This test script contains test method(s) for Health News page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestHealthNews extends BaseTest {
	...
	public void testHealthNews(){
		...
		selenium.logComment("Navigating to Health News Page");
		selenium.logComment("Verifying that all the required elements are present on Health News Page");
		...
		selenium.logComment("Navigating to Health News Page");
		watchVideosPage.clickHealthNewsWatchNow();
