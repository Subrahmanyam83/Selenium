...
/**
 * 
 * This test script contains test method(s) for VIP Recipes page under 'Watch Videos' module.
 * @author Jaya
 */
public class TestVIPRecipes extends BaseTest {
	...
	public void testVIPRecipes(){
		...
		selenium.logComment("Navigating to VIP Recipes Page");
		selenium.logComment("Verifying that all the required elements are present on VIP Recipes Page");
		...
		selenium.logComment("Navigating to VIP Recipes Page");
		watchVideosPage.clickVIPRecipesWatchNow();
