...
/**
 *
 * This test script contains test method(s) for Success Stories page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestSuccessStories extends BaseTest {
	 ...
	 */ 
	@Test
	public void testSuccessStories(){
		...
		selenium.logComment("Navigating to Success Stories Page");
		selenium.logComment("Verifying that all the required elements are present on Success Stories Page");
		...
		selenium.logComment("Navigating to Success Stories Page");
		watchVideosPage.clickSuccessStoriesWatchNow();
