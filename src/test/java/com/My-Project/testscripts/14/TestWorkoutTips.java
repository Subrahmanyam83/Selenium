...
/**
 * This test script contains test method(s) for Workout Tips page under 'Watch Videos' module.
 * @author Jaya
 */
public class TestWorkoutTips extends BaseTest {
	...
	public void testWorkoutTips(){
		...
		selenium.logComment("Navigating to Workout Tips Page");
		selenium.logComment("Verifying that all the required elements are present on Workout Tips Page");
		...
		selenium.logComment("Navigating to Workout Tips Page");
		watchVideosPage.clickWorkoutTipsWatchNow();
