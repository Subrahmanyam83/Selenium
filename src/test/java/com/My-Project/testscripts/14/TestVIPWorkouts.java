...
/**
 * 
 * This test script contains test method(s) for VIP Workouts page under 'Watch Videos' module.
 * @author Jaya
 */
public class TestVIPWorkouts extends BaseTest {
	...
	public void testVIPWorkouts(){
		...
		selenium.logComment("Navigating to VIP Workouts Page");
		selenium.logComment("Verifying that all the required elements are present on VIP Workouts Page");
		...
		selenium.logComment("Navigating to VIP Workouts Page");
		watchVideosPage.clickVIPWorkoutsWatchNow();
