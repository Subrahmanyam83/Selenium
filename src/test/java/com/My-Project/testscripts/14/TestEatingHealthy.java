...
/**
 *
 * This test script contains test method(s) for Eating Healthy page under 'Watch Videos' module.
 *  @author Jaya
 */
	public class TestEatingHealthy extends BaseTest {
		...
		public void testContests(){
			...
			selenium.logComment("Navigating to Eating Healthy Page");
			selenium.logComment("Verifying that all the required elements are present on Eating Healthy Page");
			...
			selenium.logComment("Navigating to Eating Healthy Page");
			watchVideosPage.clickEatingHealthyWatchNow();
