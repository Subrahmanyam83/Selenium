...
/**
 *
 * This test script contains test method(s) for Products page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestProducts extends BaseTest {
	...
	public void testProducts(){
		...
		selenium.logComment("Navigating to Products Page");
		selenium.logComment("Verifying that all the required elements are present on Products Page");
		...
		selenium.logComment("Navigating to Products Page");
		watchVideosPage.clickProductsWatchNow();
