...
/**
 * 
 * This test script contains test method(s) for VIP Stylr Tips page under 'Watch Videos' module.
 * @author Jaya
 */
public class TestVIPStyleTips extends BaseTest {
	...
	public void testVIPStyleTips(){
		...
		selenium.logComment("Navigating to VIP Style Tips Page");
		selenium.logComment("Verifying that all the required elements are present on VIP Style Tips Page");
		...
		selenium.logComment("Navigating to VIP Style Tips Page");
		watchVideosPage.clickVIPStyleTipsWatchNow();
