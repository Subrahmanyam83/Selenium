...
/**
 *
 * This test script contains test method(s) for Celebrity Trainer page under 'Watch Videos' module.
 *  @author Jaya
 */
public class TestCelebrityTrainers extends BaseTest {
	 ...
	 */ 
	@Test
	public void testCelebrityTrainers(){
		...
		selenium.logComment("Navigating to Celebrity Trainers Page");
		selenium.logComment("Verifying that all the required elements are working correctly on CelebrityTrainers Page");
		...
		selenium.logComment("Navigating to Celebrity Trainers Page");
		watchVideosPage.clickCelebrityTrainersWatchNow();
