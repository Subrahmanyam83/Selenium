...
public class TestProgramsPage extends BaseTest implements ProgramsTab {
	...
	public void testResetPrograms() {
		...
		selenium.logComment("Navigating to Edit Programs Page.");
		selenium.logComment("Extracting existing Programs state on Edit Programs Page and saving them in a map. This will help to verify if the data is actually reset after clicking on reset button.");
		selenium.logComment("Selecting all the programs radio buttons.");
		selenium.logComment("Clicking on Reset Button");
		selenium.logComment("Verifying that the Fitness Programs checkboxes are reset correctly.");
		selenium.logComment("Verifying that the Activities checkboxes are reset correctly.");
		selenium.logComment("Verifying that the Gear checkboxes are reset correctly.");
		selenium.logComment("Verifying that the Supplements checkboxes are reset correctly.");
	...
	public void testSavePrograms() {
		...
		selenium.logComment("Navigating to Edit Programs Page.");
		selenium.logComment("Selecting all the programs radio buttons.");
		selenium.logComment("Clicking on Save Programs button.");
		selenium.logComment("Verifying that all the Fitness programs checkboxes are selected.");
		selenium.logComment("Verifying that all the Activities checkboxes are selected.");
		selenium.logComment("Verifying that all the Gear checkboxes are selected.");
		selenium.logComment("Verifying that all the Supplements checkboxes are selected.");
		selenium.logComment("Unchecking all the programs Checkboxes.");
		selenium.logComment("Clicking on Save Programs button.");
		selenium.logComment("Signing out of the website.");
		selenium.logComment("Executing assertEmpty method");
		selenium.logComment("################## Scope of this test method ######################");
